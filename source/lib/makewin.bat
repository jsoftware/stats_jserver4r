...
@rem copy the directory ~addons/stats/r/jserver4r/lib anywhere and open in the console
@rem copy in R.dll and libj.dll (should be at least 901)
...
gcc -m64 -I. -I"c:/Program Files/R/R-4.3.2/include" ^
 -L. -lR -lj -shared ^
